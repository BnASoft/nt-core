...
<div class="clearfix mb-3">
    <div class="float-left pt-1 tcount">
        ...
        <a class="member-edit ml-2" href="./memberForm.php"><i data-feather="user-plus"></i></a>
    </div>
...
<div class="col">
    <div class="row bg-light border py-2">
        <div class="col-2 text-center"><?php echo _('Number'); ?></div>
        ...
        <div class="col-2 text-center"><?php echo _('Member since'); ?></div>
        <div class="col-1 text-center"><?php echo _('Edit'); ?></div>
    </div>
    <ul class="list-unstyled mb-0">
        <?php
        for ($i = 0; $row = array_shift($result); $i++) {
            $mbEdit = '<a class="member-edit" href="./memberForm.php?uid='.$row['mb_uid'].'"><i data-feather="edit"></i></a>';
        ?>
        <li class="row py-2 border-bottom">
            <div class="col-2"><?php echo getHtmlChar($row['mb_uid']); ?></div>
            ...
            <div class="col-2 text-center"><?php echo substr($row['mb_date'], 2, -3); ?></div>
