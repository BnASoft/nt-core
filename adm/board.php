...
<div class="clearfix mb-3">
    <div class="float-left pt-1 tcount">
        ...
        <a class="board-edit ml-2" href="./boardForm.php"><i data-feather="plus-square"></i></a>
    </div>
...
<div class="col">
    ...
    for ($i = 0; $row = array_shift($result); $i++) {
        $boEdit = '<a class="board-edit" href="./boardForm.php?bo_id='.$row['bo_id'].'"><i data-feather="edit"></i></a>';
