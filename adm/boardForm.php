...
<div class="col-md-6 my-4">
    ...
    <form name="fconfig" method="post" class="form-ajax" action="./boardFormUpdate.php" autocomplete="off">
        ...
        <div class="form-group row">
            <label for="bo_id" class="col-sm-3 col-form-label"><?php echo _('Board ID'); ?></label>
            <div class="col-sm-4">
        ...
        <div class="form-group row">
            <label for="bo_title" class="col-sm-3 col-form-label"><?php echo _('Board title'); ?></label>
            <div class="col-sm-4">
        ...
        <div class="form-group row">
            <label for="bo_use" class="col-sm-3 col-form-label"><?php echo _('Use board'); ?></label>
            <div class="col-sm-3">
        ...
        <div class="form-group row">
            <label for="bo_category" class="col-sm-3 col-form-label"><?php echo _('Board category'); ?></label>
            <div class="col-sm-6">
        ...
        <div class="form-group row">
            <label for="bo_subject_len" class="col-sm-3 col-form-label"><?php echo _('Subject length'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_page_rows" class="col-sm-3 col-form-label"><?php echo _('Lines per page'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_page_limit" class="col-sm-3 col-form-label"><?php echo _('Number of pages'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_list_level" class="col-sm-3 col-form-label"><?php echo _('List view permissions'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_view_level" class="col-sm-3 col-form-label"><?php echo _('Content view permissions'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_write_level" class="col-sm-3 col-form-label"><?php echo _('Posts written permissions'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_comment_level" class="col-sm-3 col-form-label"><?php echo _('Comments written permissions'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_reply_level" class="col-sm-3 col-form-label"><?php echo _('Permission to create replies'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_file_limit" class="col-sm-3 col-form-label"><?php echo _('Number of attachments'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_link_limit" class="col-sm-3 col-form-label"><?php echo _('Number of links'); ?></label>
            <div class="col-sm-2">
        ...
        <div class="form-group row">
            <label for="bo_captcha_use" class="col-sm-3 col-form-label"><?php echo _('Use Captcha'); ?></label>
            <div class="col-sm-3">
        ...
        <div class="form-group row">
            <label for="bo_captcha_comment" class="col-sm-3 col-form-label"><?php echo _('Use Comment Captcha'); ?></label>
            <div class="col-sm-3">
        ...
        <div class="row pb-3">
            <div class="col mt-3">
                ...
                <button type="button" class="btn btn-secondary close-popup"><?php echo _('Close'); ?></button>
            </div>
        </div>
