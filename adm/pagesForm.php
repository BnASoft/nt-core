...
$html->addStyleSheet(NT_JS_URL.DIRECTORY_SEPARATOR.'grapejs'.DIRECTORY_SEPARATOR.'css'.DIRECTORY_SEPARATOR.'grapes.min.css', 'header', 10);
$html->addStyleSheet(NT_JS_URL.DIRECTORY_SEPARATOR.'grapejs'.DIRECTORY_SEPARATOR.'css'.DIRECTORY_SEPARATOR.'grapesjs-preset-newsletter.css', 'header', 10);
$html->addStyleSheet(NT_JS_URL.DIRECTORY_SEPARATOR.'grapejs'.DIRECTORY_SEPARATOR.'css'.DIRECTORY_SEPARATOR.'material.css', 'header', 10);

$html->addJavaScript(NT_JS_URL.DIRECTORY_SEPARATOR.'grapejs'.DIRECTORY_SEPARATOR.'grapes.min.js', 'header', 10);
$html->addJavaScript(NT_JS_URL.DIRECTORY_SEPARATOR.'grapejs'.DIRECTORY_SEPARATOR.'grapesjs-preset-newsletter.min.js', 'header', 10);
$html->addJavaScript(NT_JS_URL.DIRECTORY_SEPARATOR.'grapejs'.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'grapesjs-blocks-basic.min.js', 'header', 10);
        ...
        <form name="fpages" method="post" class="form-pages" action="<?php echo NT_ADMIN_URL; ?>/pagesFormUpdate.php" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="border-bottom">
                <div class="form-group row">
                    <label for="pg_use" class="col-sm-1 col-form-label"><?php echo _('Page Use'); ?></label>
                    <div class="col-sm-2">
                ...
                <div class="form-group row">
                    <label for="pg_id" class="col-sm-1 col-form-label"><?php echo _('Page ID'); ?></label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="pg_subject" class="col-sm-1 col-form-label"><?php echo _('Subject'); ?></label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="pg_header" class="col-sm-1 col-form-label"><?php echo _('Header'); ?></label>
                    <div class="col-sm-3">
                ...
                <div class="form-group row">
                    <label for="pg_footer" class="col-sm-1 col-form-label"><?php echo _('Footer'); ?></label>
                    <div class="col-sm-3">
    ...
    jQuery(document).on("click", "form.form-pages button", function(e) {
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                ...
                if(f.w.value != "u" && typeof(data.href) != "undefined") {
                    document.location.href = data.href;
                    return;
                }

                $t.append("<div class=\"col d-block save_result save-done mx-auto mt-2\"></div>");
