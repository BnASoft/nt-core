...
//$html->addJavaScript(NT_TINYMCE_URL.DIRECTORY_SEPARATOR.'tinymce.min.js', 'header', 10);
    ...
    <div class="col-md-12">
        <form name="fwrite" method="post" class="form-write form-token" action="<?php echo NT_BOARD_URL; ?>/writeUpdate.php" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="border-top border-bottom pt-3">
                    ...
                    <div class="col">
                        ...
                        <div class="col row<?php echo $mt; ?>">
                            ...
                            <div class="ml-2 pt-1 form-check">
                                ...
                                <label for="bo_file_del_<?php echo $k; ?>" class="form-check-label"><?php echo _('File delete'); ?></label>
                            </div>
                            <?php } ?>
                        </div>
                        <?php
                ...
                <div class="form-group row">
                    <label for="bo_link_0" class="col-sm-2 col-form-label"><?php echo _d('Anti-spam code', THEME_LOCALE_DOMAIN); ?></label>
                    <div class="col">
